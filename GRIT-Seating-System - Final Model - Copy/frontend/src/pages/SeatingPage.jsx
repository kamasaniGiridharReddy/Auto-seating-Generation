          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-[var(--grit-brown-600)]/50 bg-[var(--grit-brown-800)]/30 p-6">
              ...
              <div className="space-y-4">
                {results.roomResults?.map((roomResult, i) => (
                  <div key={i} className="rounded-lg border border-[var(--grit-brown-600)]/30 bg-[var(--grit-brown-900)]/30 p-4">
                    <h3 className="mb-2 font-medium text-[var(--grit-cream)]">
                      {roomResult.room?.roomName || roomResult.room?.roomNumber || 'Room'}
                    </h3>
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        <p className="text-[var(--grit-cream)]/55">Capacity</p>
                        <p className="font-medium text-[var(--grit-gold)]">{roomResult.capacity}</p>
                      </div>
                      <div>
                        <p className="text-[var(--grit-cream)]/55">Occupied</p>
                        <p className="font-medium text-[var(--grit-cream)]">{roomResult.occupiedCount ?? roomResult.occupied ?? 0}</p>
                      </div>
                      <div>
                        <p className="text-[var(--grit-cream)]/55">Empty</p>
                        <p className="font-medium text-[var(--grit-cream)]">{roomResult.emptyCount ?? roomResult.empty ?? 0}</p>
                      </div>
                    </div>
                  </div>
                ))}
